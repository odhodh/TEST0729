...
export default function Home() {
  ...
  async function generatePerspectives() {
    ...
    try {
      ...
      setGenerated(data);
    } catch { setNotice("사례 카드를 생성하지 못했습니다. 잠시 후 다시 시도해 주세요."); }
    setLoading(false);
  }
